...
def schedule():
    ...
    try:
        ...
        if models is None:
            return jsonify({"success": False, "error": "Model not loaded. Please upload and train data first."}), 500
        result = predict_sms_schedule(nouveau_sms, model_path=current_app.config["MODEL_PATH"], models=models)
